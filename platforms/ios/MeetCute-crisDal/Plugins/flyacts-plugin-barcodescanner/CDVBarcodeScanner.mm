...
- (UIView*)buildOverlayView {
    ...
    toolbar.items = [NSArray arrayWithObjects:torchlight,flexSpace,cancelButton,flexSpace,shutterButton,nil];
#else
    toolbar.items = [NSArray arrayWithObjects:torchlight,flexSpace,cancelButton,nil];
#endif
